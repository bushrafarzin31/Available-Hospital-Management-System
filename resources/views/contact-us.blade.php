      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('available_hospital')}}">Available Hospital</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('medical_services')}}">Medical_services</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('Patients_info')}}">News</a>
            </li>
...
<!-- Authentication done -->
  ...
  <div class="page-section" method="POST">
    <div class="container">
...
@endif
      ...
      <form class="contact-form mt-5"  action="{{route('contact.send')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
